...
- [ ] `cargo fmt` has been run — code is formatted
- [ ] `cargo clippy --workspace --all-features -- -D warnings` is clean
- [ ] `cargo test --workspace --all-features` passes
- [ ] `cargo check --workspace` passes without default features
...
Anything the reviewer should pay particular attention to, tricky parts of the implementation, or decisions you were uncertain about.
